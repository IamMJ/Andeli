...
public class ConversationStep : ScriptableObject
{
    ...
    [SerializeField] public ReplyOption resultFromOption0 = ReplyOption.MoveToNextConvoStep;
    ...
    public enum ReplyOption { MoveToNextConvoStep, SkipOneConvoStep, QuitConvo};
}
